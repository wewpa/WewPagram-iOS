        ...
        return { item, layoutConstants, _, _, _, _ in
            ...
            return (contentProperties, nil, CGFloat.greatestFiniteMagnitude, { constrainedSize, position in
                ...
                for attribute in item.message.attributes {
                    ...
                    } else if attribute is WewDeletedMessageAttribute {
                        wewIsDeletedGhost = true
                    }
                }
                ...
                if let statusType = statusType {
                    ...
                    statusSuggestedWidthAndContinue = statusLayout(ChatMessageDateAndStatusNode.Arguments(
                        ...
                        wewIsDeletedGhost: wewIsDeletedGhost
                    ))
                }
                ...
                return (suggestedBoundingWidth, { boundingWidth in
                    ...
                    return (boundingSize, { [weak self] animation, synchronousLoads, itemApply in
                        if let strongSelf = self {
                            ...
                            strongSelf.textNode.textNode.layer.opacity = wewIsDeletedGhost ? 0.5 : 1.0
