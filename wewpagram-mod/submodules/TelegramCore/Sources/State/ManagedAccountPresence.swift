...
private final class AccountPresenceManagerImpl {
    ...
    private func updatePresence(_ isOnline: Bool) {
        // Ghost Mode "online status" toggle: force offline regardless of
        // what the rest of the app thinks our state is.
        let effectiveIsOnline = WewPagramSettings.shared.disableOnlineStatus ? false : isOnline
